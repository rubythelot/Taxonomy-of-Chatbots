...
(function () {
  ...
  const COMPLEXITY = [
    { id: "low", label: "Low", note: "static content, few integrations", rank: 1 },
    { id: "medium", label: "Medium", note: "integrations + session state", rank: 2 },
    { id: "high", label: "High", note: "tools, auth, orchestration", rank: 3 },
  ];
  ...
  const ARCHETYPES = {
    ask: {
      ...
      realWorld: "Long-tail support and policy help.",
    ...
    guide: {
      ...
      realWorld: "Onboarding, issue intake, and qualification.",
    ...
    do: {
      ...
      realWorld: "Order, ticket, and workflow automation.",
    ...
    create: {
      ...
      realWorld: "Drafting, summarizing, and asset generation across generative copilots.",
    ...
    analyze: {
      ...
      realWorld: "Website search, BI, and decision support.",
    ...
    coach: {
      ...
      realWorld: "Learning, onboarding, and guided practice.",
    ...
    monitor: {
      ...
      realWorld: "Customer care, alerts, and next-best-action in proactive CX platforms.",
    ...
    escalate: {
      ...
      realWorld: "Sensitive cases and failure recovery.",
